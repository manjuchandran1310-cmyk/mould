...
export default function Page() {
  ...
  function reset() { setCode(sampleCode); setSelectedLine(8); setSelectedRange([8, 8]); setLevel('beginner'); setTool('select'); setThreads([]); setNote(''); setMarks([]); setAnalyzed(true); setPointing(false); setPointReady(false); setPointStart(null) }
